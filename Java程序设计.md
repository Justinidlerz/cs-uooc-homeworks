...
3. <p><span style="font-size:14px;font-family:宋体">设各个变量的定义如下：（</span><span style="font-size:14px;font-family:&#39;Times New Roman&#39;,serif">&nbsp; &nbsp;</span><span style="font-size:14px;font-family:宋体">）选项的值为</span><span style="font-size:14px;font-family:&#39;Times New Roman&#39;,serif">true</span><span style="font-size:14px;font-family:宋体">。</span></p><p><span style="font-size:14px;font-family:宋体"></span></p><p>int a=1,b=1;</p><p>boolean flag=a!=b++;</p><p><span style="font-size:14px;font-family:宋体"><br/></span><br/></p>   
    ...
    <font color=red >C: (++a==b) || flag;</font>
...
9. <p>在Java中函数main（）的返回值是：（）</p>   
    ...
    <font color=red >D: void</font>

    <p>&nbsp;</p>

10. <p>java应用在消费电子市场上开发平台名称为:</p>   
...
1. 构造方法何时被调用   
    ...
    <font color=red >B: 创建对象时</font>

    <p>&nbsp;</p>

2. <p>在编写Java Application程序时，若需要使用到标准输入输出语句，必须在程序的开头写上（&nbsp;&nbsp;&nbsp;&nbsp;）语句。</p>   

    <font color=red >C: import java.io.*</font>

    <p>&nbsp;</p>

3. <p>认真阅读代码，选择正确的选项</p><p>public &nbsp;class &nbsp;MyClass &nbsp;{</p><p>&nbsp; &nbsp; &nbsp; &nbsp; public &nbsp;static &nbsp;void &nbsp;main(String &nbsp;arguments[]) &nbsp;{</p><p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; amethod(arguments);</p><p>&nbsp; &nbsp; &nbsp; &nbsp; }</p><p>&nbsp; &nbsp; &nbsp; &nbsp; public &nbsp;void &nbsp;amethod(String[] &nbsp;arguments) &nbsp;{</p><p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; System.out.println(arguments);</p><p>&nbsp; &nbsp; &nbsp; &nbsp; }<br/></p><p>}</p><p><br/></p>   

    <font color=red >C: 这段代码是错误的，main方法不能调用实例方法</font>

    <p>&nbsp;</p>

4. 在Java中，一个类可以同时定义许多同名的方法，这些方法的形式参数的个数、类型或顺序各不相同，传回的值也可以不相同。这种面向对象程序特性称为（&nbsp;&nbsp;&nbsp;&nbsp;）   

    <font color=red >C: 重载</font>

    <p>&nbsp;</p>

5. 下面关于构造函数的说法不正确的是   

    <font color=red >B: 构造函数不可以重载。</font>

    <p>&nbsp;</p>

6. 命令javac&nbsp;&nbsp;&nbsp;&nbsp;-verbose&nbsp;&nbsp;&nbsp;&nbsp;中选项的作用是:   

    <font color=red >A: 显示JVM加载class的过程</font>

    <p>&nbsp;</p>

7. <p>给出类的定义如下:</p><p>&nbsp; 1.</p><p>class Test{&nbsp;</p><p>&nbsp; &nbsp;void test(int i){&nbsp;</p><p>&nbsp; &nbsp; System.out.println(&quot;I am an int.&quot;);</p><p>&nbsp; &nbsp;}</p><p>&nbsp; &nbsp;void test(String s){ &nbsp; &nbsp; &nbsp; &nbsp;</p><p>&nbsp; &nbsp; System.out.println(&quot;I am a string.&quot;);</p><p>&nbsp; &nbsp;}</p><p>&nbsp; &nbsp;public static void main(String args[]) {&nbsp;</p><p>&nbsp; &nbsp; &nbsp;Test t=new Test();</p><p>&nbsp; &nbsp; &nbsp;char ch=&#39;y&#39;;</p><p>&nbsp; &nbsp; &nbsp; t.test(ch); }</p><p>&nbsp; &nbsp;}</p><p>&nbsp; &nbsp; 下列描述哪个正确? &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</p>   

    <font color=red >C: 代码将编译并输出以下结果： I am an int.</font>
...
5. <p>运行下列程序，会产生什么结果：</p><p>import java.io.*;</p><p>public class &nbsp;Outer1{ &nbsp;</p><p>　　　private &nbsp;int &nbsp;a； &nbsp;</p><p>　　　void &nbsp;foo（double &nbsp;d，final &nbsp;float &nbsp;f）{ &nbsp;</p><p>　　　　String &nbsp;s； &nbsp;</p><p>　　　　final &nbsp;boolean &nbsp;b； &nbsp;</p><p>　　　　class &nbsp;Inner{ &nbsp;</p><p>　　　　　void &nbsp;methodInner（）{ &nbsp;</p><p>　　　　　　System.out.println（“in &nbsp;the &nbsp;Inner“）； &nbsp;</p><p>　　　　　} &nbsp;</p><p>　　　　} &nbsp;</p><p>　　　} &nbsp;</p><p>　　　public &nbsp;static &nbsp;void &nbsp;main（String &nbsp;args[]） &nbsp;</p><p>　　{ &nbsp;</p><p>　　Outer1 &nbsp;me=new &nbsp;Outer1（）； &nbsp;</p><p>　　me.foo（123，123）； &nbsp;</p><p>　　System.out.println（“outer“）； &nbsp;</p><p>　　} &nbsp;</p><p>　} &nbsp;</p><p><br/></p>   

    <font color=red >B: outer</font>

    <p>&nbsp;</p>

6. <p>编译及运行以下代码，下列选项哪个是正确的</p><p>public &nbsp;class &nbsp;Ref{</p><p>&nbsp; &nbsp; &nbsp; &nbsp; public &nbsp;static &nbsp;void &nbsp;main(String &nbsp;argv[]){</p><p>&nbsp; &nbsp; &nbsp; &nbsp; Ref &nbsp;r &nbsp;= &nbsp;new &nbsp;Ref();</p><p>&nbsp; &nbsp; &nbsp; &nbsp; r.amethod(r);</p><p>&nbsp; &nbsp; &nbsp; &nbsp; }</p><p>&nbsp; &nbsp; &nbsp; &nbsp; public &nbsp;void &nbsp;amethod(Ref &nbsp;r){</p><p>&nbsp; &nbsp; &nbsp; &nbsp; int &nbsp;i=99;</p><p>&nbsp; &nbsp; &nbsp; &nbsp; multi(r);</p><p>&nbsp; &nbsp; &nbsp; &nbsp; System.out.println(i);</p><p>&nbsp; &nbsp; &nbsp; &nbsp; }</p><p>&nbsp; &nbsp; &nbsp; &nbsp; public &nbsp;void &nbsp;multi(Ref &nbsp;r){</p><p>&nbsp; &nbsp; &nbsp; &nbsp; r.i &nbsp;= &nbsp;r.i*2;</p><p>&nbsp; &nbsp; &nbsp; &nbsp; }</p><p>}</p><p><br/></p>   

    <font color=red >A: 编译错误</font>
...
1. <p>this关键字指的是？</p>   
    ...
    <font color=red >B: 当前类的实例对象</font>

    <p>&nbsp;</p>

2. <p>如果类中的成员变量仅仅可以被同一包中其他类访问，则使用如下哪个约束符?</p>   

    <font color=red >D: no modifier</font>

    <p>&nbsp;</p>

3. <p>如果任何包中的子类都能访问超类中的成员，那么超类中的成员使用哪个限定词最好（ ）</p>   

    <font color=red >C: protected</font>

    <p>&nbsp;</p>

4. <p>不允许作为类及类成员的访问控制符的是:</p>   

    <font color=red >C: static</font>

    <p>&nbsp;</p>

5. <p>下面哪个修饰符修饰的方法只能被本类中的其他方法使用</p>   

    <font color=red >C: private</font>

    <p>&nbsp;</p>

6. <p>某个类的成员变量可以被同一个包中的子类访问，但不能被另一个包中的类（含子类）访问，该如何定义？</p>   

    <font color=red >D: 变量不需做任何修饰。</font>

    <p>&nbsp;</p>

7. <p>关于被私有访问控制符private修饰的成员变量，以下说法正确的是（        ）</p>   

    <font color=red >C: 只能被该类自身所访问和修改</font>
...
1. <p>考虑类A:</p><p>&nbsp;public class A{&nbsp;</p><p>&nbsp; &nbsp; public int x=1；</p><p>&nbsp; &nbsp; public void increaseBy（int &nbsp;n）</p><p>&nbsp; {
x=x+n；
}
}&nbsp;</p><p>以下哪个选项程序代码段输出结果不会产生4?</p>   

    <font color=red >C: A a = new A（ ）{public void increaseBy （int n） {super.increaseBy（n）；}}；a.increaseBy（4）；System.out.print（a.x）；</font>
...
1. <p>以下哪几段代码可以成功编译？（）</p><p>1)</p><p>import &nbsp;java.awt.*;</p><p>package &nbsp;Mypackage;</p><p>class &nbsp;Myclass &nbsp;{}</p><p><br/></p><p>2)</p><p>package &nbsp;MyPackage;</p><p>import &nbsp;java.awt.*;</p><p>class &nbsp;MyClass{}</p><p><br/></p><p>3)</p><p>/*This &nbsp;is &nbsp;a &nbsp;comment &nbsp;*/</p><p><br/></p><p>package &nbsp;MyPackage;</p><p>import &nbsp;java.awt.*;</p><p>class &nbsp;MyClass{}</p><p><br/></p>   

    <font color=red >B: 2）和3）</font>

    <p>&nbsp;</p>

2. <p>创建一个名为MyPackage包的语句正确的是______。</p>   
